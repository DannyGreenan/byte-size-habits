...
const HeroBar = () => {
  ...
  return (
    <div className="bg-base-100 border-2 border-base-100 w-full max-w-4xl mx-auto m-10 rounded-2xl">
        ...
        <div className="drawer flex">
          ...
          <div className="drawer-content flex-1 m-auto ">
            ...
            <div className="flex justify-between">
              ...
              <label
                htmlFor="my-drawer"
                className="btn btn-primary btn-outline drawer-button font-nunito font-extrabold m-1 ml-3">
                <PiNotebook size={26} />
                Tutorials
              </label>
          ...
          <div className="drawer-side flex-2">
            <label
              htmlFor="my-drawer"
